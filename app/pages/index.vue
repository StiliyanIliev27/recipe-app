		...
		<section class="bg-[#f1f1f1]">
			<div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
				<div class="flex-1 order-2 lg:order-1 text-center lg:text-left">
					...
					<button class="px-4 py-2 text-white self-start bg-dodgeroll-gold-500 rounded-md text-lg cursor-pointer">
						Browse Recipes
					</button>
				</div>
				<div class="flex-1 order-1 lg:order-2">
					<NuxtImg sizes="xs:100vw sm:667px" format="webp" src="/nuxt-course-hero.png" alt="" />
				</div>
			</div>
		</section>
